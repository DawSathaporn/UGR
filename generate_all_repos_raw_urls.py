...
Ambil semua file dari SELURUH repository milik satu user/org (contoh: DawSathaporn),
buat URL raw GitHub untuk tiap file, lalu simpan ke CSV dan XLSX.

Contoh pakai (publik repos):
  python generate_all_repos_raw_urls.py DawSathaporn --out data/DawSathaporn_all_raw.csv

Jika ingin sertakan private repos:
  export GITHUB_TOKEN="ghp_..."  # PAT scope: repo
  python generate_all_repos_raw_urls.py DawSathaporn --out data/DawSathaporn_all_raw.csv --workers 10
"""
...
def main():
    ...
    ap.add_argument("owner", help="Username/Org GitHub. Contoh: DawSathaporn")
